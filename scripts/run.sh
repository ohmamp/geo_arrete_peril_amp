...
python src/create_pages_dataframe.py ${DATA_INT}/${BATCH}_meta_ntxt.csv ${DATA_INT}/${BATCH}_ntxt_pages.csv
...
# 1 sortie: CSV de métadonnées enrichies 1 ligne par page)
python src/evaluate_native_text.py ${DATA_INT}/${BATCH}_meta_ntxt.csv ${DATA_INT}/${BATCH}_ntxt_pages.csv ${DATA_INT}/${BATCH}_meta_ntxt_proc.csv
...
# 7. extraire la structure du texte: en-têtes, pieds-de-pages, VUs, CONSIDERANTs, ARTICLEs etc.
